 ...
 */
@WebServlet(name = "Jijin",urlPatterns = "/jijin")
public class Jijin extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session1 != null){
            ...
            Integer Value = Integer.valueOf(value);
            UserAddachieve userAddachieve = new UserAddachieve();
            userAddachieve.addjijin(uid, Value);
            out.print("<!--\n" +
                    " * @Author: your name\n" +
